...
<!-- ===== BACK TO TOP BUTTON ===== -->
<button onclick="scrollToTop()" id="back-to-top" aria-label="Volver arriba"
   class="fixed bottom-40 right-6 z-[98] bg-white text-brand-pink border border-pink-200 w-12 h-12 rounded-full flex items-center justify-center shadow-xl hover:bg-brand-light transition-all hidden">
